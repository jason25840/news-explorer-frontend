    ...
    return (
        <div className={`mobile-menu__overlay ${isSavedNewsPage ? 'mobile-menu__overlay--white' : ''}`}>
            ...
            <div className="mobile-menu__content">
                <Link to="/" className="mobile-menu__home-link" onClick={handleClose}>Home</Link>
                {isLoggedIn && (
                    <>
                    <div className="mobile-menu__second-row">
                        <Link to="/saved-articles" className="mobile-menu__saved-articles-link" onClick={handleClose}>Saved articles</Link>
