...
const About = () => {
    return ( 
        ...
        <div className="about_description">
            ...
            <p className='tripleten-talk'>TripleTen has helped me move closer to my goal of becoming a softyware developer. The Software Engineering course is flexible with its schedule and there is support every step of the way!</p>
        </div>
        </div>
        </div>
     );
